...
def test_hash_file_non_existent_file():
...
def test_commit_hash_parent_none():
...
def test_same_commit_objects_get_same_hash_parent_none():
...
def test_different_hashes_for_different_parent_commits():
...
def test_different_hashes_for_different_parent_commits_one_none():
