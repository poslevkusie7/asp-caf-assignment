...
class TestNonExistentContent:
    def test_open_non_existent_file(self, temp_repo_dir):
        non_existent_hash = 'deadbeef' + '0' * 32

        with raises(RuntimeError):
            open_content_for_reading(temp_repo_dir, non_existent_hash)

    def test_delete_non_existent_file(self, temp_repo_dir):
        non_existent_hash = 'deadbeef' + '0' * 32
...
class TestContent:
    ...
    def test_save_file_content(self, temp_repo_dir, temp_content):
    ...
    def test_open_content_for_reading(self, temp_repo_dir, temp_content):
        file, expected_content = temp_content
    ...
    def test_open_content_for_writing(self, temp_repo_dir, temp_content):
        file, expected_content = temp_content
    ...
    def test_save_and_delete_content(self, temp_repo_dir, temp_content):
        file, _ = temp_content
