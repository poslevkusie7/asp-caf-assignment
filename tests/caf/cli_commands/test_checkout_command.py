...
def test_checkout_by_branch_name_sets_head_symbolic_and_updates_workdir(temp_repo: Repository, parse_commit_hash: Callable[[], str], capsys: CaptureFixture[str]) -> None:
