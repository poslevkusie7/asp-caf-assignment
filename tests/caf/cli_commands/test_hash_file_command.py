...
def test_hash_file_without_write(temp_repo, temp_content, capsys):
...
def test_hash_file_with_write(temp_repo, temp_content, capsys):
...
def test_hash_file_does_not_exist(temp_repo, capsys):
...
def test_hash_file_twice(temp_repo, capsys):
...
def test_hash_file_no_repo(temp_repo_dir, capsys):
