...
public:
    ...
    const std::vector<std::string> parents; // Parent commit hashes

    Commit(const std::string& tree_hash, const std::string& author, const std::string& message, std::time_t timestamp, const std::vector<std::string>& parents = {}):
